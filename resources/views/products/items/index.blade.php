      ...
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
          	@if (\Request::is('product/items/index/1'))
							...
							<tbody>
								@foreach ($items as $index => $item)
									<tr>
										...
										<td>
                      <div class="btn-group">
  											<a href="{{ route('item.edit', ['id' => $item->id]) }}" class="btn btn-default btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
  											<a href="{{ route('item.trash', ['id' => $item->id]) }}" class="btn btn-default btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
                      </div>
										</td>
									</tr>
								@endforeach
