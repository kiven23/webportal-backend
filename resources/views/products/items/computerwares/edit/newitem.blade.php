...
@section('title', 'Add to Computerware Tickets')
...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('ticket.computerwares') }}">Computer Tickets</a></li>
      <li><a href="{{ route('ticket.computerware.edit', ['id' => $computerware->id]) }}">Edit Ticket</a></li>
    ...
    <div class="row mt-4 mb-4">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <form method="post" action="{{ route('item.store', ['computerware_id' => $computerware->id]) }}">
						{{ csrf_field() }}
						<div class="box-body">
							<div class="row">
								<div class="col-md-5">
									...
									<div class="form-group {{ $errors->has('brand_select') ? 'has-error' : ($errors->has('brand_input') ? 'has-error' : ($errors->has('brand_duplicate') ? 'has-error' : '')) }}">
										...
										<span id="brand_select">
											...
											<select class="form-control" name="brand_select">
						...
						<div class="box-footer">
							<div class="row">
								<div class="col-md-5">
									<button value=4 name="savebtn" type="submit" class="btn btn-info" title="Save Ticket">
										<i class="fa fa-ticket"></i>
										Save Ticket
									</button>
									<a href="{{ route('ticket.computerware.edit', ['id' => $computerware->id]) }}" class="btn btn-default pull-right">Back</a>
								</div>
							</div>
						</div>
					</form>
