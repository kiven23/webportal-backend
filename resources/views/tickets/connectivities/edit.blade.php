...
@section('title', 'Edit Connectivity Ticket')
      ...
      <div class="col-md-12">
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">
              Edit connectivity Ticket
            </h3>
          </div>
          <form method="post" action="{{ route('ticket.connectivity.update', ['id' => $connectivity->id]) }}">
						{{ csrf_field() }}
						<div class="box-body">
							<div class="row">
								<div class="col-md-8">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group {{ $errors->has('problem') ? 'has-error' : '' }}">
												<label>Problem</label>
												<textarea class="form-control" type="text" name="problem" placeholder="Problem" autofocus>{{ $connectivity->problem }}</textarea>
													...
													<select class="form-control select2" name="service_provider_select">
														@foreach ($service_providers as $service_provider)
															<option
																...
																{{ $connectivity->service_provider_id == $service_provider->id ? 'selected' : '' }}
													...
													<select class="form-control select2" name="service_type_select">
														@foreach ($service_types as $service_type)
															<option
																...
																{{ $connectivity->service_type_id == $service_type->id ? 'selected' : '' }}
													...
													<select class="form-control select2" name="service_category_select">
														@foreach ($service_categories as $service_category)
															<option
																...
																{{ $connectivity->service_category_id == $service_category->id ? 'selected' : '' }}
												...
												<span id="branch_select">
													...
													<select class="form-control select2" name="branch_select">
														@foreach ($branches as $branch)
															<option
																value="{{ $branch->id }}"
																{{ $connectivity->branch_id == $branch->id ? 'selected' : '' }}
																>{{ $branch->name }}</option>
														@endforeach
													</select>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('reported_by_name') ? 'has-error' : '' }}">
												...
												<input class="form-control" type="text" name="reported_by_name" value="{{ $connectivity->reported_by_name }}" placeholder="Complete Name" autofocus>
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('reported_by_position') ? 'has-error' : '' }}">
												...
												<input class="form-control" type="text" name="reported_by_position" value="{{ $connectivity->reported_by_position }}" placeholder="Position" autofocus>
					              ...
					              <input type="text" class="form-control" id="problem-reported" name="problem_reported" value="{{ $connectivity->problem_reported_ho }}">
					              ...
					              <input type="text" class="form-control" id="resolution-reported" name="resolution_reported" value="{{ $connectivity->resolution_reported }}">
					              ...
					              <input type="text" class="form-control" id="problem-reported-to-isp" name="problem_reported_to_isp" value="{{ $connectivity->problem_reported_isp }}">
					              ...
					              @endif
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('provider_ticket') ? 'has-error' : '' }}">
												...
												<input class="form-control" type="text" name="provider_ticket" value="{{ $connectivity->provider_ticket }}" placeholder="Provider Ticket" autofocus>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('remarks') ? 'has-error' : '' }}">
												...
												<textarea rows="1" class="form-control" type="text" name="remarks" placeholder="Last Update" autofocus>{{ $connectivity->remarks }}</textarea>
