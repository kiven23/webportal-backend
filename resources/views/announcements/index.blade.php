    ...
    <div class="row mt-4 mb-4">
          ...
          <div class="box-header with-border">
            ...
            <div class="box-toolbar pull-right">
              <a href="{{ route('announcement.create') }}" class="btn btn-primary btn-xs">
                      ...
                      <div class="btn-group">
                        ...
                        >
                          <i class="fa fa-eye"></i>
  											...
  											<a href="{{ route('announcement.edit', ['id' => $announcement->id]) }}" class="btn btn-default btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
  											<a href="{{ route('announcement.trash', ['id' => $announcement->id]) }}" class="btn btn-default btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
                      </div>
										</td>
									</tr>
								@endforeach
