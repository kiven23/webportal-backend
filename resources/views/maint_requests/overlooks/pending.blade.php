...
@section('title', 'Overlook Maintenance Requests')
            ...
            @include ('successes.list')
          	<table class="table table-bordered table-hover" id="maint-request-table">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="{{ route('maint_request.view', ['id' => $maint_request->id]) }}" class="btn btn-default btn-xs" title="Edit"><i class="fa fa-eye"></i></a>
                      </div>
                    </td>
                  </tr>
                @endforeach
