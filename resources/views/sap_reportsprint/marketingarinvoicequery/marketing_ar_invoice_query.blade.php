...
<td class="s0" dir="ltr">MARKETING AR-INVOICE QUERY</td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<td class="s0" dir="ltr" style="width: 15px;">NAME</td>
<td class="s0" dir="ltr">ADDRESS</td>
<td class="s0" dir="ltr">BRAND</td>
<td class="s0" dir="ltr">PRODUCTCATEGORY</td>
<td class="s0" dir="ltr">MODEL</td>
 
<td class="s0" dir="ltr">CONTACTNO.</td>
...
<td class="s1" dir="ltr"><strong>{{$data->NAME}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->ADDRESS}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->BRAND}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->PRODUCTCATEGORY}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->MODEL}}</strong></td>

<td class="s1" dir="ltr"><strong>{{$data->CONTACTNO}}</strong></td>
