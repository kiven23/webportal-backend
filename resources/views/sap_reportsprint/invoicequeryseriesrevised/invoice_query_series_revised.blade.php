...
<td class="s0" dir="ltr">INVOICE QUERY SERIES REVISED</td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<td class="s0" dir="ltr" style="width: 15px;">INVOICE#</td>
<td class="s0" dir="ltr">DOCUMENT DATE</td>
<td class="s0" dir="ltr">DOCUMENT NUMBER</td>
<td class="s0" dir="ltr">NAME OF CUSTOMER</td>
<td class="s0" dir="ltr">INVOICE AMOUNT</td>
<td class="s0" dir="ltr">STATUS</td>
<td class="s0" dir="ltr">PAYMENT TERM</td>
<td class="s0" dir="ltr">CLOSED TYPE</td>
...
<td class="s1" dir="ltr"><strong>{{$data->DOCUMENTDATE}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->DOCUMENTNUMBER}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->NAMEOFCUSTOMER}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->INVOICEAMOUNT}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->STATUS}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->PaymentTerms}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->CLOSEDTYPE}}</strong></td>
</tr>
@endforeach
</tr><tr style="height: 20px">
