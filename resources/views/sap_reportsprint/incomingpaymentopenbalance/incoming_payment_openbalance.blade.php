...
<td class="s0" dir="ltr">INCOMING PAYMENT OPEN BALANCE</td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<td class="s0" dir="ltr" style="width: 15px;">SERIESNAME</td>
<td class="s0" dir="ltr">SERIES</td>
<td class="s0" dir="ltr">DOCDATE</td>
<td class="s0" dir="ltr">DOCNUM</td>
<td class="s0" dir="ltr">CARDNAME</td>
<td class="s0" dir="ltr">COUNTER REF</td>
<td class="s0" dir="ltr">OPEN BAL</td>
...
<td class="s1" dir="ltr"><strong>{{$data->SeriesName}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->Series}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->DocDate}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->DocNum}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->CardName}}</strong></td>

<td class="s1" dir="ltr"><strong>{{$data->CounterRef}}</strong></td>
 
<td class="s1" dir="ltr"><strong>{{$data->OpenBal}}</strong></td>
</tr>
@endforeach
</tr><tr style="height: 20px">
