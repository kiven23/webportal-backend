...
<td class="s0" dir="ltr">SEARCHING OF VEHICLE PARTS</td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<td class="s0" dir="ltr" style="width: 15px;">CATEGORY</td>
<td class="s0" dir="ltr">VEHICLE PART</td>
<td class="s0" dir="ltr">BODY TYPE</td>
<td class="s0" dir="ltr">EXPENSE TYPE</td>
<td class="s0" dir="ltr">LIFE SPAN</td>
...
<td class="s1" dir="ltr"><strong>{{$data->CATEGORY}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->VEHICLEPART}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->BODYTYPE}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->EXPENSETYPE}}</strong></td>
<td class="s1" dir="ltr"><strong>{{$data->LIFESPAN}}</strong></td>
</tr>
@endforeach
</tr><tr style="height: 20px">
