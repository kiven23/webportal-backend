...
@section('title', 'Edit Branch Schedule')
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row mt-4 mb-4">
          ...
          <form method="post" action="{{ route('branch-schedule.update', ['id' => $branch_schedule->id]) }}">
						{{ csrf_field() }}
						<div class="box-body">
							<div class="row">
								<div class="col-md-5">
                  ...
                  <div class="form-group timepicker {{ $errors->has('time_from') ? 'has-error' : '' }}">
                    ...
                    <input id="time_from"
                          ...
                          type="text"
                          class="form-control"
                          value="{{ $branch_schedule->time_from }}">
