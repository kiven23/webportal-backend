    ...
    <div class="row mt-4 mb-4">
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="box-body">
            <table id="otbreport" class="table table-bordered table-condensed">
                  ...
                  @foreach ($useremployments as $useremployment)
                    @if ($user->user_id === $useremployment->user_id)
                      <tr>
                        ...
                        <td>{{ $useremployment->pre_totaltime + $useremployment->post_totaltime }}</td>
                        <?php
                          $runningtotal += ($useremployment->pre_totaltime + $useremployment->post_totaltime);
                          $subtotal += ($useremployment->pre_totaltime + $useremployment->post_totaltime)
                        ?>
                      </tr>
                    @endif
                  @endforeach
