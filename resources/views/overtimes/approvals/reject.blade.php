...
@section('title', 'Reject Filed Overtime')
    ...
    <div class="row mt-4 mb-4">
      <div class="col-md-12">
        <div class="box box-danger">
          ...
          <form action="{{ route('approval.proceed_reject', ['id' => $pending->id]) }}" method="post">
            {{ csrf_field() }}
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-5">
                  ...
                  You are about to reject this file with the following details:
                  <ul>
                    <li>
