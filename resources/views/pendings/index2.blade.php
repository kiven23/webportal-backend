      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">
              {{ strtoupper(\Auth::user()->branch->name) }} pendings as of {{ Carbon\Carbon::now()->format('F d, Y') }}
            </h3>
            <div class="box-toolbar pull-right">
	            <div class="btn-group">
	            	<a href="{{ route('pending.create') }}" class="btn btn-primary btn-xs">
									<i class="fa fa-plus"></i> Add new Pending
								</a>
        ...
        <div class="box box-warning">
				  <div class="box-header with-border">
						<h3 class="box-title">
							{{ strtoupper(\Auth::user()->branch->name) }} previous pendings <em>({{ Carbon\Carbon::now()->addDay(-1)->format('F d, Y') }})</em>
						</h3>
					</div>
				  <div class="box-body">
						<div class="table-responsive">
	                        ...
	                        <ul class="dropdown-menu">
	                          <li>
	                          	<a class="dropdown-item" href="{{ route('pending.readd', ['id' => $pending->id]) }}">Add</a>
	                          </li>
	                        </ul>
	                      </div>
											</td>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.table').delegate('#delbtn','click', function() {
			var branch_id = <?php echo count($pendings) > 0 ? $pending->branch_id : 1; ?>;
