...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{ $branch_name }}</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">
              {{ strtoupper($branch_name) }} pendings as of {{ Carbon\Carbon::now()->format('F d, Y') }}
            </h3>
            <div class="box-toolbar pull-right">
							<a href="{{ route('pending.branch.chart', ['id' => $id]) }}" class="btn btn-warning btn-xs">
          ...
          <div class="box-body table-responsive">
          	@include ('errors.list')
                        ...
                        <ul class="dropdown-menu">
                          <li>
                          	<a class="dropdown-item" href="{{ route('pending.edit_as', ['id' => $pending->branch_id, 'pending_id' => $pending->id]) }}">Edit</a>
                          </li>
                          <li>
						...
						<div class="row">
							<div class="col-md-8">
								<p><strong>Note: </strong>You can add your previous pending(s) below.</p>
							</div>
							<div class="col-md-4">
								<p class="text-info"><strong>Legend:</strong></p>
								<p><strong class="text-danger">LSU - </strong> Last Series Used</p>
							</div>
						</div>
          </div>
        </div>
        ...
        <div class="box box-warning">
				  <div class="box-header with-border">
						<h3 class="box-title">
							{{ strtoupper($branch_name) }} previous pendings <em>({{ Carbon\Carbon::now()->addDay(-1)->format('F d, Y') }})</em>
						</h3>
						<div class="box-toolbar pull-right">
							<a href="{{ route('pending.add_all', ['id' => $id]) }}" class="btn btn-primary btn-xs">
				  ...
				  <div class="box-body">
						<div class="table-responsive">
	                        ...
	                        <ul class="dropdown-menu">
	                          <li>
	                          	<a class="dropdown-item" href="{{ route('pending.readd_as', ['id' => $pending->id]) }}">Add</a>
	                          </li>
	                        </ul>
	                      </div>
											</td>
							...
							<p><strong>Note: </strong>You can add this pending(s) to your pending as of this date for less inconvenience. Just click on the &nbsp;<i class="fa fa-ellipsis-v fa-2x"></i>&nbsp; icon on the left and click "Add" link to add.</p>
						</div>
				  </div>
				</div>
      </div>
