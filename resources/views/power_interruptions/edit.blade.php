...
@section('title', 'Edit Power Interruption Log')
    ...
    <div class="row mt-4 mb-4">
      <div class="col-md-12">
        <div class="box box-warning">
          ...
          <form method="post" action="{{ route('power_interruption.update', ['id' => $power_interruption->id]) }}">
						{{ csrf_field() }}
						<div class="box-body">
							<div class="row">
								<div class="col-md-8">
												...
												<span id="branch_select">
													...
													<select class="form-control select2" name="branch_select">
														@foreach ($branches as $branch)
															<option
																value="{{ $branch->id }}"
																{{ $power_interruption->branch_id == $branch->id ? 'selected' : '' }}
																>{{ $branch->name }}</option>
														@endforeach
													</select>
						            ...
						            <input type="text" class="form-control" id="problem-reported" name="problem_reported" value="{{ $power_interruption->problem_reported }}">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('reported_by_name') ? 'has-error' : '' }}">
												...
												<input class="form-control" type="text" name="reported_by_name" value="{{ $power_interruption->reported_by_name }}" placeholder="Complete Name" autofocus>
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('reported_by_position') ? 'has-error' : '' }}">
												...
												<input class="form-control" type="text" name="reported_by_position" value="{{ $power_interruption->reported_by_position }}" placeholder="Position" autofocus>
						            ...
						            <input type="text" class="form-control" id="date-time-from" name="datetime_from" value="{{ $power_interruption->datetime_from }}">
						            ...
						            <input type="text" class="form-control" id="date-time-to" name="datetime_to" value="{{ $power_interruption->datetime_to }}">
				          ...
				          <div class="form-group {{ $errors->has('remarks') ? 'has-error' : '' }}">
										...
										<textarea class="form-control" name="remarks">{{ $power_interruption->remarks }}</textarea>
