...
@section('title', 'Delete Service type')
      ...
      <div class="col-md-12">
        <div class="box box-danger">
          ...
          <div class="box-body">
						...
						<ul>
							<li><strong>Name: </strong> {{ $service_type->name }}</li>
						</ul>

						<em>Connectivity Tickets under this record:</em>
							<ol>
								@forelse ($service_type->connectivity_tickets as $connticket)
									<li>
										<ul>
					...
					<div class="box-footer">
						<form method="post" action="{{ route('service_type.delete', ['id' => $service_type->id]) }}">
							{{ csrf_field() }}
							<button type="submit" class="btn btn-danger">Proceed</button>
							<a href="{{ route('service_types') }}" class="btn btn-default">No, go back</a>
						</form>
					</div>
				</div>
			</div>
