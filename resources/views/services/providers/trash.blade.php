...
@section('title', 'Delete Service Provider')
      ...
      <div class="col-md-12">
        <div class="box box-danger">
          ...
          <div class="box-body">
						...
						<ul>
							<li><strong>Name: </strong> {{ $service_provider->name }}</li>
						</ul>

						<em>Connectivity Tickets under this record:</em>
							<ol>
								@forelse ($service_provider->connectivity_tickets as $connticket)
									<li>
										<ul>
					...
					<div class="box-footer">
						<form method="post" action="{{ route('service_provider.delete', ['id' => $service_provider->id]) }}">
							{{ csrf_field() }}
							<button type="submit" class="btn btn-danger">Proceed</button>
							<a href="{{ route('service_providers') }}" class="btn btn-default">No, go back</a>
						</form>
					</div>
				</div>
			</div>
