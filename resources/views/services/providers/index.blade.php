        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            <div class="box-toolbar pull-right">
              <a href="{{ route('service_provider.create') }}" class="btn btn-primary btn-xs">
                <i class="fa fa-plus"></i>&nbsp;ADD
              </a>
            </div>
          </div>
          <div class="box-body table-responsive">
          	@if (\Request::is('service_providers/index/1'))
							...
							<tbody>
								@foreach ($service_providers as $index => $service_provider)
									<tr>
										...
										<td>
                      <div class="btn-group">
  											<a href="{{ route('service_provider.edit', ['id' => $service_provider->id]) }}" class="btn btn-default btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
  											<a href="{{ route('service_provider.trash', ['id' => $service_provider->id]) }}" class="btn btn-default btn-xs" title="Delete"><i class="fa fa-trash"></i></a>
                      </div>
										</td>
									</tr>
								@endforeach
