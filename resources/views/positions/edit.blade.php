    ...
    <div class="row mt-4 mb-4">
      <div class="col-md-12">
        <div class="box box-warning">
          ...
          <form role="form" action="{{ route('position.update', ['id' => $position->id]) }}" method="post">
            {{ csrf_field() }}
            <div class="box-body">
              <div class="row">
                <div class="col-md-5">
            ...
            <div class="box-footer">
              <div class="row">
                <div class="col-md-5">
                  ...
                  <a href="{{ route('positions.index') }}" type="submit" class="btn btn-default pull-right">Cancel</a>
                </div>
              </div>
            </div>
          </form>
