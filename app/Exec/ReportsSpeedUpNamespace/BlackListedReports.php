        ...
        if($db){
            ...
            ->select( \DB::raw("
                    ...
                    WHEN  e.Name = 'Sta. Cruz' THEN 'SANTA CRUZ'
                     ELSE e.Name END  COLLATE DATABASE_DEFAULT AS Branch,
                    ...
                    WHERE c.Segment_0 IN ('11230') AND 
                    ...
                    left join [@Progtbl] br on T2.SeriesName = br.U_Series1 COLLATE DATABASE_DEFAULT
                    ...
                    inner join OCTG c1 on c1.Groupnum = c.Groupnum and c1.PymntGroup <> 'CreditCard'
                    ...
                    and ((right(i.seriesname,4) = 'CHRG' and c1.PymntGroup not in ('CASH','V-Cash')) or f1.Segment_0 = '71110' 
                    or (p3.ContraAct is not null and c1.PymntGroup = N'CHECK')) 
                    and (dd.ReconDate >= @x1 and dd.ReconDate <= @x2) 
                    group by a.TransId
