...
class CreditStandingController extends Controller
{
    ...
    public function index(request $req){
        ...
        return $ar;
         ...
         $table =  DB::table("credit_portal")->where("db", $this->mssqlcon())->where('branch',$branch)->get();
...
$table = \DB::connection($this->mssqlcon())->select(DB::raw("
                    ...
                    if($table){
                        \DB::table("credit_portal")->where("db", $this->mssqlcon())->truncate();
                    }
                    
                    foreach($table as $data){
                      
                        DB::table('credit_portal')->insert([
